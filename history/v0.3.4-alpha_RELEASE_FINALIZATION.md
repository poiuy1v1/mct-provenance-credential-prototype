# HISTORICAL / SUPERSEDED - v0.3.4-alpha release finalization

> This document records the historical `v0.3.4-alpha` release workflow only.
> It is not an instruction set for `v0.3.6-alpha`, does not describe current
> release state, and must not be used to create or modify a contemporary tag,
> GitHub Release, Zenodo record, DOI, manuscript or supporting information.
